...
public class AdminCategoryController {
    ...
    public CategoryDto createCategory(@RequestBody @Valid NewCategoryDto categoryDto, HttpServletRequest request) {
    ...
    public CategoryDto patchCategory(@PathVariable Long id,
                                     @RequestBody @Valid NewCategoryDto categoryDto, HttpServletRequest request) {
        log.info("{}", ControllerLog.createUrlInfo(request));
